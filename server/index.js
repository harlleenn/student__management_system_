...
const {studentValidation , studentValidate} = require("./middlewares/studentInputValidation")
const {passwordValidation , passwordValidate} = require('./middlewares/resetPasswordValidation')
...
app.post("/auth/reset-password",  passwordValidation, passwordValidate, async (req, res) => {
